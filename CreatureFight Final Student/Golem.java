...
public class Golem extends Creature
{
    ...
    public void act() 
    {
        ...
        {
            getWorld().showText("golem has done the faint", getWorld().getWidth()/2, getWorld().getHeight()/2 + 26);
            Greenfoot.delay(30);
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if(enemyType == "electric")
            {
                ...
                getWorld().showText("thou arts attack twas very effective",getWorld().getWidth()/2,getWorld().getHeight()/2+26);
                Greenfoot.delay(30);
            }
