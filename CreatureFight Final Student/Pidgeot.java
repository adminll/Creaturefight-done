...
public class Pidgeot extends Creature
{
    ...
    public void act() 
    {
        ...
        {
            getWorld().showText("pidgeot has done the fainted", getWorld().getWidth()/2, getWorld().getHeight()/2 + 26);
            Greenfoot.delay(30);
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if(enemyType.equalsIgnoreCase  ("Grass"))
            {
                ...
                getWorld().showText("thou arts attack twas very effetive",getWorld().getWidth()/2,getWorld().getHeight()/2+26);
                Greenfoot.delay(30);
            }
